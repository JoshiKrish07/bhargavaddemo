            ...
            <div className="dashboard-content-wrap">
              <div className="profile-info-wrap">
                ...
                <div className="profile-content">
                  ...
                  {/* <p>
                    You Have Complete 10 Auction In Last Month. Start Your
                    auction Today.
                  </p> */}
                </div>
              </div>
              <div className="row g-lg-3 gy-4">
                <div className="col-lg-4">
                  <div className="single-counter-card">
                    ...
                    {/* <h2>{Object.keys(userData)?.length}</h2> */}
                    <h2>
                      {
                        Object.values(userData).filter(
                          (item) =>
                            item?.lot_id !== null && item?.lot_id !== undefined
                        ).length
                      }
                    </h2>
                  </div>
              ...
              <div className="bidding-summary-wrap">
                ...
                <table className="bidding-summary-table">
                  ...
                  <tbody>
                    {/* <td data-label="Status"><span className="cancel">{userData[index]?.lot_status}</span></td> */}
                    {/* {Object.keys(userData).slice(indexOfFirstItem, indexOfLastItem).map((index, data) => {
                      return (
                        <tr>
                          ...
                          <td data-label="Status">
                            <span>{userData[index]?.lot_status}</span>
                          </td>
                          <td data-label="Auction Date">
                            {userData[index]?.bid_date}
                          </td>
                        </tr>
                      );
                    })} */}
                ...
                <div className="col-lg-12">
                  <div className="custom-pagination-area">
                    <ul>
                      ...
                      {[
                        ...Array(
                          Math.ceil(Object.keys(userData).length / itemsPerPage)
                        ).keys(),
                      ].map((num) => (
                        <li key={num + 1}>
                          <button
